		...
		<div id="content-wrapper">
			...
			<div class="container-fluid">
				...
				<FORM METHOD="post"
					...
					<br> <input type="hidden" name="memAcc"
						value="<%=memberVO.getMemAcc()%>"> <input type="hidden"
						name="memBirth" value="<%=memberVO.getMemBirth()%>"> <input
						type="hidden" name="memEmail" value="<%=memberVO.getMemEmail()%>">
					<input type="hidden" name="memSex"
						value="<%=memberVO.getMemSex()%>"> <input type="hidden"
						name="memIDcard" value="<%=memberVO.getMemIDcard()%>"> <input
						type="hidden" name="memReg" value="<%=memberVO.getMemReg()%>">
