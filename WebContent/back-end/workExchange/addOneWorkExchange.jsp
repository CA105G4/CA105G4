...
<!-- 				</div> -->
				...
				<div class="form-group">
					...
					<input class="form-control" type="text" name="memID" readonly="true"
					value="${workExchangeVO.memID}">${memberSvc.getOneMem(workExchangeVO.memID).memName}
				</div>
				<div class="form-group">
					<label for="rtID">房型名稱</label>
				...
				<div class="form-group">
					<label for="weName">需求名稱</label>
					<input type="text" class="form-control" name="weName" id="weName"><div style="color:red">${errMsgs.weName}</div>
				</div>	
				<div class="form-group">
					<label for="weContent">需求內容</label>
					<textarea class="form-control" name="weContent" style="resize:none" id="weContent"></textarea><div style="color:red">${errMsgs.weContent}</div>
				</div>	
				<div class="form-group">
					<label for="wePic">選擇照片</label>
					<input type="file" class="form-control" name="wePic" id="wePic"><div style="color:red">${errMsgs.wePic}</div>
				</div>	
				<div class="form-group">
					<label for="weVideo">選擇影片</label>
					<input type="file" class="form-control" name="weVideo" id="weVideo"><div style="color:red">${errMsgs.weVideo}</div>
				</div>	
				<div class="form-group">
					<label for="weStart">開始時間</label>
					<input type="text" name="weStart" id="start">
				</div>	
				<div class="form-group">
					<label for="weEnd">結束時間</label>
					<input type="text" name="weEnd" id="end">
				</div>	
					<input type="submit" class="btn-success form-control" value="確認新增">
