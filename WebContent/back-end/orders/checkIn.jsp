...
<%
	...
	List<OrdersCheckInOutVO> checkInlist = ordSvc.findCheckInByOrdJoinOD(today, "B01");
						...
						<table class="table table-bordered table-striped table-hover">
							...
							<c:forEach var="ordcheckInVO" items="${checkInlist}">
								<tr>
									...
									<td>
									  <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/orders/orders.do" style="margin-bottom: 0px;">
									     <input type="submit" value="CheckIn" class="btn btn-info">
									     <input type="hidden" name="ordID"  value="${ordcheckInVO.ordID}">
									     <input type="hidden" name="action" value="CheckIn"></FORM>
									</td>
								</tr>
							</c:forEach>
						</table>
