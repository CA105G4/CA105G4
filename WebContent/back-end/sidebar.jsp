...
<body id="page-top">
	...
	<ul class="sidebar navbar-nav">
		...
		<li class="nav-item active"><a class="nav-link" href="index.html">
				<i class="fa fa-home"></i> <span>當日房況一覽</span>
		</a></li>
		...
		<li class="nav-item dropdown"><a class="nav-link dropdown-toggle"
			...
			<div class="dropdown-menu" aria-labelledby="pagesDropdown2">
				...
				<a class="dropdown-item"
					href="<%=request.getContextPath()%>/back-end/orders/listAllOrders.jsp">查詢訂單</a>
				<a class="dropdown-item"
					href="<%=request.getContextPath()%>/back-end/orders/addorders.jsp">新增訂單</a>
				<div class="dropdown-divider"></div>
				<h6 class="dropdown-header">列表:</h6>
				<a class="dropdown-item"
					href="<%=request.getContextPath()%>/back-end/orders/normalOrders.jsp">一般訂單列表</a>
				<a class="dropdown-item"
					href="<%=request.getContextPath()%>/back-end/orders/workExchangeOrders.jsp">打工換宿訂單列表</a>
				<a class="dropdown-item"
					href="<%=request.getContextPath()%>/back-end/orders/returnOrders.jsp">退訂訂單列表</a>
			</div></li>
		<li class="nav-item dropdown"><a class="nav-link dropdown-toggle"
			...
			<div class="dropdown-menu" aria-labelledby="pagesDropdown3">
				<h6 class="dropdown-header">新增/查詢:</h6>
				<a class="dropdown-item" 
					href="<%=request.getContextPath()%>/back-end/workExchange/addOneWorkExchange.jsp">新增打工需求</a>
				<div class="dropdown-divider"></div>
				<h6 class="dropdown-header">列表:</h6>
				<a class="dropdown-item" 
					href="<%=request.getContextPath()%>/back-end/workExchange/listAllWorkExchange.jsp">打工需求列表</a>
			</div></li>
		<li class="nav-item dropdown"><a class="nav-link dropdown-toggle"
			href="#" id="pagesDropdown3" role="button" data-toggle="dropdown"
			aria-haspopup="true" aria-expanded="false"> <i class="fa fa-edit"></i>
...
<%-- 					href="<%=request.getContextPath()%>/back-end/roomType/select_roomType_page.jsp">查詢房型</a> --%>
				...
				<h6 class="dropdown-header">列表:</h6>
				<a class="dropdown-item"
					href="<%=request.getContextPath()%>/back-end/roomType/listAllRoomType.jsp">房型列表</a>
			</div></li>
		<li class="nav-item dropdown"><a class="nav-link dropdown-toggle"
			href="#" id="pagesDropdown3" role="button" data-toggle="dropdown"
			aria-haspopup="true" aria-expanded="false"> <i class="fa fa-edit"></i>
			...
			<div class="dropdown-menu" aria-labelledby="pagesDropdown3">
				<h6 class="dropdown-header">新增/查詢:</h6>
				<a class="dropdown-item" 
					href="<%=request.getContextPath()%>/back-end/room/addRoom.jsp">新增房間</a>
				<a class="dropdown-item" 
					href="<%=request.getContextPath()%>/back-end/room/HomePage.jsp">查詢房間</a>
				<div class="dropdown-divider"></div>
				<h6 class="dropdown-header">列表</h6>
<!-- 				<a class="dropdown-item" href="blank.html">選擇日期</a> -->
				<a class="dropdown-item" 
					href="<%=request.getContextPath()%>/back-end/room/listAllRoom.jsp">所有房間</a>
			</div></li>
		<li class="nav-item dropdown"><a class="nav-link dropdown-toggle"
			href="#" id="pagesDropdown3" role="button" data-toggle="dropdown"
			aria-haspopup="true" aria-expanded="false"> <i class="fa fa-edit"></i>
			...
			<div class="dropdown-menu" aria-labelledby="pagesDropdown3">
				<h6 class="dropdown-header">新增/查詢:</h6>
				<a class="dropdown-item" 
					href="<%=request.getContextPath()%>/back-end/member/addMember.jsp">新增會員</a>
				<div class="dropdown-divider"></div>
				<h6 class="dropdown-header">列表:</h6>
				<a class="dropdown-item" 
					href="<%=request.getContextPath()%>/back-end/member/listAllMem.jsp">會員列表</a>
			</div></li>
		<li class="nav-item dropdown"><a class="nav-link dropdown-toggle"
			href="#" id="pagesDropdown3" role="button" data-toggle="dropdown"
			aria-haspopup="true" aria-expanded="false"> <i class="fa fa-edit"></i>
		...
		<li class="nav-item dropdown"><a class="nav-link dropdown-toggle"
			...
			<div class="dropdown-menu" aria-labelledby="pagesDropdown3">
				...
				<h6 class="dropdown-header">列表:</h6>
				<a class="dropdown-item" 
					href="<%=request.getContextPath()%>/back-end/billboard/listAllBillBoard.jsp">輪播廣告列表</a> 
			</div></li>
		<li class="nav-item dropdown"><a class="nav-link dropdown-toggle"
			href="#" id="pagesDropdown3" role="button" data-toggle="dropdown"
			aria-haspopup="true" aria-expanded="false"> <i class="fa fa-edit"></i>
			...
			<div class="dropdown-menu" aria-labelledby="pagesDropdown3">
				<h6 class="dropdown-header">新增:</h6>
				<a class="dropdown-item" 
					href="<%=request.getContextPath()%>/back-end/activity/addAct.jsp">新增促銷活動</a>
				<div class="dropdown-divider"></div>
				<h6 class="dropdown-header">列表:</h6>
				<a class="dropdown-item" 
					href="<%=request.getContextPath()%>/back-end/activity/listAllActivity.jsp">促銷活動列表</a>
			</div></li>
		<li class="nav-item dropdown"><a class="nav-link dropdown-toggle"
			href="#" id="pagesDropdown3" role="button" data-toggle="dropdown"
			aria-haspopup="true" aria-expanded="false"> <i class="fa fa-edit"></i>
			...
			<div class="dropdown-menu" aria-labelledby="pagesDropdown3">
				<h6 class="dropdown-header">新增:</h6>
				<a class="dropdown-item" 
					href="<%=request.getContextPath()%>/back-end/coupon/addCoupon.jsp">新增優惠劵</a>
				<div class="dropdown-divider"></div>
				<h6 class="dropdown-header">列表:</h6>
				<a class="dropdown-item" 
					href="<%=request.getContextPath()%>/back-end/coupon/listAllCoupon.jsp">優惠劵列表</a>
			</div></li>
		<li class="nav-item dropdown"><a class="nav-link dropdown-toggle"
			href="#" id="pagesDropdown3" role="button" data-toggle="dropdown"
			aria-haspopup="true" aria-expanded="false"> <i class="fa fa-edit"></i>
		...
		<li class="nav-item dropdown"><a class="nav-link dropdown-toggle"
			...
			<div class="dropdown-menu" aria-labelledby="pagesDropdown3">
				<h6 class="dropdown-header">新增:</h6>
				<a class="dropdown-item" 
					href="<%=request.getContextPath()%>/back-end/branch/addBra.jsp">新增分店</a>
				<div class="dropdown-divider"></div>
				<h6 class="dropdown-header">列表:</h6>
				<a class="dropdown-item" 
					href="<%=request.getContextPath()%>/back-end/branch/listAllBranch.jsp">分店列表</a>
			</div></li>
