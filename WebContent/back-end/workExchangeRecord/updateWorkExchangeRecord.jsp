      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <hr>
          	<div class="container-fluid">
				<div class="row">
				<form method="post" action="<%=request.getContextPath()%>/workExchangeRecord/workExchangeRecord.do" enctype="multipart/form-data" style="margin-bottom: 0px;">
				<jsp:useBean id="memberSvc" class="com.member.model.MemberService"/>
				
				<table>
					<tr>
						<th>需求編號:&nbsp;</th>
						<td>${workExchangeRecordVO.weID}<input type="hidden" class="form-control" name="weID" value="${workExchangeRecordVO.weID}"></td>
					</tr>
					<tr>
						<th>會員姓名:&nbsp;</th>
						<td>${memberSvc.getOneMem(workExchangeRecordVO.memID).memName}
						<input type="hidden" class="form-control" name="memID" value="${workExchangeRecordVO.memID}"></td>
					</tr>
					<tr>
						<th>審核狀況:&nbsp;</th>
						<td>
						<select name="werState" id="werState" class="form-control">
					...
					<tr>
						<th>訂單編號:&nbsp;</th>
						<td>${workExchangeRecordVO.orderID}<input type="hidden" class="form-control" name="orderID" value="${workExchangeRecordVO.orderID}"></td>
					</tr>
					<tr>
						<th>申請圖片:&nbsp;</th>
						<td><img src="<%=request.getContextPath()%>/workExchangeRecord/workExchangeRecordImg.do?weID=${workExchangeRecordVO.weID}&memID=${workExchangeRecordVO.memID}" class="img-fluid">
						</td>
					</tr>
					<tr>
						<td></td>
						<td>
							<input type="hidden" name="weApp" value="${workExchangeRecordVO.weApp}">
