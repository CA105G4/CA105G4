              ...
              <div class="table-responsive">
				...
				<c:forEach var="reportVO" items="${list}">
					<tr>
						...
						<td>
							<c:if test = "${reportVO.repstate =='0'}" > ${ status[0]} </c:if>
				...
				<c:if test = "${reportVO.repstate =='0'}"> 
            		<td>
						  <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/report/report.do" style="margin-bottom: 0px;">
						     ...
						     <input type="hidden" name="artid"  value="${reportVO.artid}">
						     <input type="hidden" name="repreason"  value="${reportVO.repreason}">
						     <input type="hidden" name="repdate"  value="${reportVO.repdate}">
						     <input type="hidden" name="repmemid"  value="${reportVO.repmemid}">
						     <input type="hidden" name="repstate"  value="1">
						     <input type="hidden" name="repid"  value="${reportVO.repid}">
						     <input type="hidden" name="action"	value="status_Update"></FORM>
					</td>
					<td>
					  <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/report/report.do" style="margin-bottom: 0px;">
					     ...
					     <input type="hidden" name="repdate"  value="${reportVO.repdate}">
					     <input type="hidden" name="repmemid"  value="${reportVO.repmemid}">
					     <input type="hidden" name="repstate"  value="2">
					     <input type="hidden" name="repid"  value="${reportVO.repid}">
					     <input type="hidden" name="repid"  value="${reportVO.repid}">
