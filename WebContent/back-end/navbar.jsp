...
<!-- 			</li> -->
			...
			<li class="nav-item dropdown no-arrow">
				...
				<span class="navbar-brand mr-1" style="color: #DDDDDD;">${braSvc.getOneByID(employeeVO.braID).braName} , ${employeeVO.empName}</span>
			</li>
...
<!-- 					<i class="fas fa-user-circle fa-fw"></i> -->
					<img src="<%=request.getContextPath()%>/employee/empImg.do?empID=${employeeVO.empID}" style="border-radius: 50%; width:30px; height: 30px">
				</a>
				
				<div class="dropdown-menu dropdown-menu-right"
					aria-labelledby="userDropdown">
					<a class="dropdown-item" href="<%=request.getContextPath()%>/back-end/employee/listSelfEmpInfo.jsp">Info</a> 
