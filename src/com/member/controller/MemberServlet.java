...
//				
				...
				if (!errorMsgs.isEmpty()) {
					...
					RequestDispatcher failureView = req.getRequestDispatcher("/back-end/member/update_mem_input.jsp");
					failureView.forward(req, res);
					return;
				}
				 ...
				 *****************************************/
				MemberService memSvc = new MemberService();
				memberVO = memSvc.updateMem(memID, memName, memAcc, memPsw, memBirth, memEmail, memTel, memAddr, memSex,
						memSkill, memState, memPic, memReg, memIDcard);
				/***************************
