...
//	private static final String GET_BY_BRAID_STMT = "SELECT roomType.rtId, roomType.braId, roomType.rtName, roomType.rtIntro, roomType.holidayPrice, roomType.balance FROM branch" + 
//			"INNER JOIN roomType on branch.braId = roomType.braId WHERE branch.braName = ?";
	private static final String GET_BY_BRAID_STMT = "SELECT * FROM branch INNER JOIN roomType on branch.braId = roomType.braId WHERE branch.braName = ?";
...
//	}
	...
	public List<RoomTypeBra> findByBraName(String braName){
		...
		try {
			con = ds.getConnection();
			pstmt = con.prepareStatement(GET_BY_BRAID_STMT);
